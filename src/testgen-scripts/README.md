`generateTests` is a Python script that takes all of the tests in `tests.csv` and creates all of the variants of `ETH/ERC20` and `Linear/Exponential/Xyk` tests.
