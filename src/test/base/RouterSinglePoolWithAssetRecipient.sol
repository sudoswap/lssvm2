...
abstract contract RouterSinglePoolWithAssetRecipient is Test, ERC721Holder, ConfigurableWithRoyalties, RouterCaller {
    ...
    function test_swapSingleNFTForToken() public {
        ...
        uint256 afterBuyPairNFTBalance = test721.balanceOf(address(buyPair));
